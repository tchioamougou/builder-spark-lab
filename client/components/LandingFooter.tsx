        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-8 items-start">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-start">
                <svg className="w-4 h-4 mr-2 mt-0.5 text-[#ff9900]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                </svg>
                <span>Meiganga, Région de l'Adamaoua<br />Cameroun</span>
              </div>
              <div className="flex items-center">
                <svg className="w-4 h-4 mr-2 text-[#ff9900]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="lg:col-span-1">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link to="/about" className="hover:underline">{t('pages.about')}</Link></li>
              <li><Link to="/formations" className="hover:underline">{t('pages.formations')}</Link></li>
              <li><Link to="/admissions" className="hover:underline">{t('pages.admissions')}</Link></li>
            </ul>
          </div>
          ...
          <div className="lg:col-span-1">
            ...
            <ul className="space-y-2 text-sm">
              <li><Link to="/actualites" className="hover:underline">{t('pages.news')}</Link></li>
              <li><Link to="/faq" className="hover:underline">{t('pages.faq')}</Link></li>
              <li><Link to="/recrutement" className="hover:underline">{t('pages.recruitment')}</Link></li>
              <li><Link to="/contacts" className="hover:underline">{t('pages.contact')}</Link></li>
            </ul>
          </div>
        </div>
