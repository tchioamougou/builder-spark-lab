              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
                ...
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    ...
                    contribuent à améliorer le système de santé national.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
              ...
              <div className="bg-white rounded-3xl shadow-lg p-8 text-center">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Former des professionnels de santé compétents, éthiques et
                  dévoués, capables de répondre aux défis sanitaires du Cameroun
                  et de l'Afrique, en privilégiant l'excellence académique et
                  l'approche humaine des soins.
                </p>
              </div>
