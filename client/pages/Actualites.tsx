  ...
  const articles = [
    {
      ...
      categorie: "Formation",
      image: MyFie,
      extrait: "L'EPFPS lance un nouveau programme spécialisé en soins d'urgence pour répondre aux besoins croissants du secteur de la santé au Cameroun.",
    ...
    },
    {
      ...
      extrait: "Signature d'un accord de partenariat avec l'hôpital régional de Meiganga pour renforcer la formation pratique de nos étudiants.",
      contenu: "Lorem ipsum dolor sit amet, consectetur adipiscing elit..."
    }
  ];
        ...
        >
          ...
          <div className="container mx-auto px-4 relative z-10 text-center">
            <h1 className="heading-font text-4xl md:text-6xl font-bold mb-6">
              <span className="text-[#ff9900]">{t('pages.news')}</span>
            </h1>
          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {articles.map((article) => (
                <article key={article.id} className="bg-white rounded-3xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
