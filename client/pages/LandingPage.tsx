            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-gray-100 p-6 rounded-2xl shadow-lg">
                <p className="italic text-gray-600 mb-4">
                  "Une expérience incroyable qui a transformé ma carrière. La
                  qualité de l'enseignement est exceptionnelle et le soutien des
                  professeurs est inégalable."
                </p>
                <div className="flex items-center gap-4">
                  <img
                    src="https://placehold.co/60x60/ff9900/ffffff?text=Visage"
              ...
              <div className="bg-gray-100 p-6 rounded-2xl shadow-lg">
                <p className="italic text-gray-600 mb-4">
                  "J'ai pu développer des compétences concrètes et trouver un
                  emploi dans une entreprise prestigieuse juste après
              ...
              <div className="bg-gray-100 p-6 rounded-2xl shadow-lg">
                <p className="italic text-gray-600 mb-4">
                  "Le réseau d'anciens élèves est une véritable force. J'ai pu
                  échanger avec des professionnels et obtenir des conseils
                  précieux pour mon parcours."
                </p>
                <div className="flex items-center gap-4">
                  <img
                    src="https://placehold.co/60x60/ff9900/ffffff?text=Visage"
        ...
        <section id="campus" className="py-20 md:py-32 bg-gray-50">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto mb-12">
              Découvrez une communauté inspirante et dynamique. Nos étudiants
              évoluent dans un environnement riche en activités sociales,
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="relative overflow-hidden rounded-3xl shadow-lg group">
                <div
                  ...
                  style={{
                    backgroundImage:
                      'url("https://placehold.co/600x400/4f3987/ffffff?text=Bibliothèque")',
                  }}
                ></div>
                <div className="absolute inset-0 bg-black/60 flex items-center justify-center p-4 transition-opacity duration-300">
                  <div className="text-white">
                    <h3 className="heading-font text-xl md:text-2xl font-bold mb-2">
                      Bibliothèque universitaire
                    </h3>
                    <p className="text-sm">
                      Explorez un environnement propice à l'étude et à la
                      recherche.
                    </p>
                  </div>
                </div>
              ...
              <div className="relative overflow-hidden rounded-3xl shadow-lg group">
                <div
                  ...
                  style={{
                    backgroundImage:
                      'url("https://placehold.co/600x400/4f3987/ffffff?text=Espaces+de+vie")',
                  }}
                ></div>
                <div className="absolute inset-0 bg-black/60 flex items-center justify-center p-4 transition-opacity duration-300">
                  <div className="text-white">
                    ...
                    <p className="text-sm">
                      Des espaces modernes conçus pour la collaboration et la
                      détente.
                    </p>
                  </div>
                </div>
              ...
              <div className="relative overflow-hidden rounded-3xl shadow-lg group">
                <div
                  ...
                  style={{
                    backgroundImage:
                      'url("https://placehold.co/600x400/4f3987/ffffff?text=Salle+de+conférence")',
                  }}
                ></div>
                <div className="absolute inset-0 bg-black/60 flex items-center justify-center p-4 transition-opacity duration-300">
                  <div className="text-white">
                    ...
                    <p className="text-sm">
                      Organisez des événements et des présentations dans des
                      salles équipées.
                    </p>
                  </div>
                </div>
          ...
          <div className="container mx-auto px-4">
            <div className="bg-white rounded-[60px] md:rounded-[120px] shadow-2xl overflow-hidden md:flex items-center">
              ...
              <div className="p-8 md:p-12 md:w-1/2 flex flex-col justify-center">
                ...
                <a
                  href="#"
                  className="inline-block w-fit bg-[#ff9900] hover:bg-[#e68a00] text-white heading-font font-bold py-3 px-8 rounded-full shadow-lg transition-all duration-300"
                >
                  Découvrir
                </a>
              </div>
              ...
              <div className="md:w-1/2 flex justify-end">
                <img
                  src="https://placehold.co/600x400/fff/3b2c6a?text=Image"
                  alt="Jeune étudiante souriante agitant la main"
                  className="w-full md:h-full object-cover rounded-tr-[60px] md:rounded-tr-[120px] rounded-br-[60px] md:rounded-br-[120px]"
                />
              </div>
            </div>
          </div>
          ...
          <div className="container mx-auto px-4">
            <div className="bg-[#e4ddf6] rounded-3xl p-8 shadow-md flex flex-col md:flex-row items-center justify-between">
              <h3 className="heading-font text-xl md:text-2xl text-[#3b2c6a] font-bold mb-4 md:mb-0 text-center md:text-left">
                ...
                parcours dans le secteur de la santé ?
              </h3>
              <a
                href="#"
                className="bg-white hover:bg-gray-200 text-[#3b2c6a] heading-font font-bold py-3 px-8 rounded-full shadow-lg transition-all duration-300"
              >
